...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : MonoBehaviour
    {
        ...
        {
            freeSpeed.walkSpeed = newWalkSpeed;
            strafeSpeed.walkSpeed = newWalkSpeed;
            freeSpeed.runningSpeed = newWalkSpeed;
            strafeSpeed.runningSpeed = newWalkSpeed;
            freeSpeed.sprintSpeed = newWalkSpeed + 0.5f;
            strafeSpeed.sprintSpeed = newWalkSpeed + 0.5f;
        ...
        public void SetJumpParameters(float newJumpHeight)
        {
        ...
        public virtual void RotateToDirection(Vector3 direction, float rotationSpeed)
        {
            ...
            direction.y = 0f;
                ...
                //transform.rotation = Quaternion.Lerp(transform.rotation, Quaternion.Euler(0, transform.rotation.eulerAngles.y, transform.rotation.eulerAngles.z), Time.deltaTime);
            ...
            //else if (_thirdPersonInput.mobileVersion)
            //{
            //    transform.rotation = Quaternion.Lerp(transform.rotation, Quaternion.Euler(-90, transform.rotation.eulerAngles.y, transform.rotation.eulerAngles.z), Time.deltaTime * 2);
            //}
        }
